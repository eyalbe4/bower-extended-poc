...
var semver = require('bower-utils').semver;
var md5 = require('bower-utils').md5;
var createError = require('bower-utils').createError;
var readJson = require('bower-utils').readJson;
var validLink = require('bower-utils').validLink;
